...
_INDICATOR_ROWS = (
    ...
    ("log_rGDP_pc_USD", "Log Real GDP per Capita USD", "growth_dynamics", "log(USD)", "gold_growth_dynamics", None, "Logarit GDP thực bình quân đầu người tính bằng USD.", ("log real GDP per capita", "log rGDP per capita", "GDP per capita", "GDP bình quân đầu người", "GDP binh quan dau nguoi", "thu nhập bình quân", "thu nhap binh quan", "income per capita", "log GDP thực bình quân", "log GDP thuc binh quan")),
    ...
    ("trade_pct_gdp", "Trade Percentage of GDP", "social_welfare", "%", "gold_social_welfare", None, "Tổng thương mại so với GDP.", ("trade percentage of GDP", "trade-to-GDP", "trade openness", "độ mở thương mại", "do mo thuong mai", "thương mại/GDP", "thuong mai/GDP", "thương mại trên GDP", "thuong mai tren GDP")),
)
